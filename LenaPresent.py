...
for i in range(n):
    ...
    # then prints rght half from i to 0 
    print(*" "*(n-i),*range(i),*range(i, -1, -1))

# LOWER HALF IS THE SAME AS UPPER HALF
# It prints the middle lane from 0 to n-1 and from n to 0. Rememeber i = n = input number for the middle lane. Hence n - i = 0; so no space. Then prints lower half. 
